...
public class ReviewFinalizer extends BaseFinalizer {
	...
	private void validateResource(String collectionId){
		...
		if(!childPublishEnabled && CollectionUtils.isNotEmpty(notPublishedList)){			TelemetryManager.error("Collection: " + collectionId + " has unpublished resources:: " + notPublishedList);
